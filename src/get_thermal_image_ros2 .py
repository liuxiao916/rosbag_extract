        ...
        with tqdm(total=msg_count) as pbar:
            ...
            while reader.has_next():
                ...
                if topic == self.topic_name:
                    ...
                    if self.save_time:
                        cv2.imwrite(os.path.join(self.save_dir, "{}.png".format(t)), cv_img)
                    else:
                        cv2.imwrite(os.path.join(self.save_dir, "{}.png".format(count)), cv_img)
                    pbar.update()
                    count +=1
...
def main():
    ...
    parser.add_argument('--topic', type=str, default='/infra_throttle')
    parser.add_argument('--save_dir', type=str, default='/media/nros-xiao-2404/HDD1/bag2/output/thermal')
